                ...
                <div className="w-full md:w-1/2 h-[300px] md:h-full bg-brand-accent px-6 md:px-16 py-6 md:py-8 flex flex-col text-brand-primary">
                  <div className="w-full max-w-xl h-full overflow-y-auto md:overflow-visible md:mt-auto md:mb-auto md:h-auto">
                    <h3 className="text-xl md:text-3xl font-bold mb-3 md:mb-4">
                      ...
                      {slide.type === "program" ? "Ongoing Program: " : ""}{" "}
                      {slide.type === "event" ? "Upcoming Event: " : ""}{" "}
                      {slide.title}
                    </h3>
                    {slide.description && (
                      <p className="text-sm md:text-base mb-4 md:mb-6 text-brand-text-muted">
                        {slide.description}
                      </p>
                    )}
                    <div className="space-y-2 mb-4 md:mb-6">
                      {slide.times &&
                        slide.times.map((time) => (
                    ...
                    <div className="flex flex-col sm:flex-row gap-2">
                      {slide.moreInfoLink && (
                        ...
                        >
                          <Link href={slide.moreInfoLink}>More Info</Link>
                        </Button>
                      )}
                      {slide.link && (
                        <Button
