        ...
        <div className="flex items-center justify-between bg-navbar-background rounded-full px-6 py-2">
          <div className="flex items-center gap-2">
            <Link href="/" className="flex items-center gap-2">
              <Image
                ...
                height={50}
              />
              <span className="text-brand-text-dark font-medium text-lg">
                Cordoba Academy
              </span>
            </Link>
          </div>
          ...
          <div className="md:hidden">
            <Sheet open={mobileMenuOpen} onOpenChange={setMobileMenuOpen}>
              ...
              <SheetContent
                side="right"
                className="bg-brand-secondary w-[300px] p-0"
              >
                          ...
                          <li key={item.name}>
                            <Link
                              ...
                              className={`flex items-center gap-3 px-4 py-3 rounded-md ${
                                active
                                  ? 'bg-navbar-border text-brand-text-dark'
                                  : 'text-brand-text-muted hover:bg-navbar-border/50'
                              }`}
                          ...
                          return (
                            <Link
                              ...
                              className={`flex items-center gap-3 px-4 py-3 rounded-md ${
                                active
                                  ? 'bg-navbar-border text-brand-text-dark'
                                  : 'text-brand-text-muted hover:bg-navbar-text/50'
                              }`}
                              onClick={() => setMobileMenuOpen(false)}
                            >
                              <IconComponent
                    ...
                    <Link
                      ...
                      className={`flex items-center gap-1.5 ${
                        active
                          ...
                          : 'text-navbar-text hover:text-brand-text-dark'
                      }`}
                    >
                      <IconComponent
                        size={18}
                ...
                if (item.name === 'Donate') {
                  return (
                    <Link key={item.name} href={item.href}>
                      <Button className="bg-brand-accent-orange hover:bg-brand-primary text-white">
                        Donate
                      </Button>
                    </Link>
                  );
                ...
                return (
                  ...
                  >
                    <IconComponent
                      size={18}
                      className={
                        active ? 'text-brand-accent-orange' : 'text-navbar-text'
                      }
                    />
                    <span>{item.name}</span>
                  </Link>
