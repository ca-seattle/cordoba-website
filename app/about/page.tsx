...
export default function AboutPage() {
  ...
  const facultyHighlights = [
    ...
    },
    {
      ...
      bio: "Sadia Rizvi is a dedicated educator with 14+ years of experience teaching elementary students with the Advanced British curriculum in Saudi Arabia. She holds a Bachelor of Education (B.Ed.) from Jamia Millia Islamia University, Delhi, and has a strong passion for nurturing young minds. Sadia finds immense joy in witnessing the progress of her students, guiding them as they grow academically and personally. She is committed to creating a positive and engaging learning environment where students feel supported and inspired to reach their full potential.\nAt Cordoba Academy, Sadia values the collaborative, supportive, and faith-centered atmosphere. She appreciates the school's dedication to both academic excellence and Islamic values, as well as the strong partnership between staff, administration, and families, making it a truly enriching place to teach.",
    ...
    },
    {
      ...
      bio: "Madiha Asghar is a certified Early Childhood Educator with extensive teaching experience. Her ECE training has provided her with expertise in classroom management, developmentally appropriate practices, curriculum development, child assessments using CDC milestones, and conducting parent-teacher conferences. She holds a Bachelor of Science degree and is currently balancing her studies while pursuing a second bachelor's degree at WSU.\nWith a deep passion for teaching preschool and elementary-age students, Madiha believes that learning is a lifelong journey, and she finds joy in growing alongside her students every day. For her, teaching is more than just a profession, it's a calling and a passion.\nFor more than five years, Madiha has been part of Cordoba Academy's mission to inspire and educate the next generation. She finds fulfillment in working at a school that empowers students with strong Islamic values, a love for learning, and the confidence to excel in both academics and character.",
