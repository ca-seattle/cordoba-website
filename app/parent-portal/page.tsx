...
export const metadata: Metadata = {
  title: "Parent Portal",
  description:
    "Access Cordoba Academy's Parent Portal for school updates, grades, and resources. Serving families in Seattle, Shoreline, Edmonds, Lynnwood, Bothell & Mountlake Terrace with comprehensive Islamic education tools.",
  openGraph: {
    title: "Parent Portal | Cordoba Academy",
    description:
      "Stay connected with your child's Islamic education journey at Cordoba Academy. Access grades, announcements, and resources for parents in the Seattle area.",
    images: ["/logo-full.png"],
  },
  keywords: [
    "Islamic School Parent Portal",
    "Muslim School Resources Seattle",
    "Cordoba Academy Parents",
    "Islamic Education Portal Lynnwood",
  ],
};
...
export default function ParentPortalPage() {
  return (
    <div className="bg-brand-secondary">
      ...
      <PageHero
        title="Parent Portal"
        subtitle="Resources and information for Cordoba Academy families"
      />
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-lg p-8 shadow-md mb-8">
            ...
            <p className="text-brand-text-muted mb-6">
              The Parent Portal provides access to important information about
              your child's education, including grades, attendance, assignments,
              and school communications. Through our School Cues system, you can
              stay connected with your child's progress and engage with our
              school community.
            </p>

            <div className="bg-brand-accent p-6 rounded-lg mb-8">
              <div className="flex items-center gap-4 mb-4">
                <div className="bg-brand-accent-orange rounded-full p-3">
              ...
              <p className="text-brand-text-muted mb-4">
                Access your School Cues account to view your child's academic
                information, communicate with teachers, and stay updated on
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              {/* <Card className="flex flex-col">
                ...
                <CardContent className="flex flex-col flex-1">
                  <CardDescription className="text-brand-text-muted mb-4">
              ...
              <Card className="flex flex-col">
                ...
                <CardContent className="flex flex-col flex-1">
                  <CardDescription className="text-brand-text-muted mb-4">
                    View the academic calendar, including holidays, events, and
      ...
      <div className="container mx-auto px-4 pb-10">
        <div className="bg-brand-primary rounded-lg p-8 text-center text-white">
          <h2 className="text-3xl font-bold mb-4">Get Involved</h2>
          <p className="max-w-2xl mx-auto mb-6">
            There are many ways to get involved in your child's education and
            the Cordoba Academy community. From volunteering in the classroom to
            joining the Parent Teacher Association, your participation makes a
            difference.
          </p>
